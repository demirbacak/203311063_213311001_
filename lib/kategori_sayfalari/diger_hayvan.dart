  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: read.digerHayvanlar.length,
            ...
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) {
                    return EvcilHayvanDetay(model: watch.digerHayvanlar[index]);
                  }));
            },
            child: (
                EvcilHayvanWidget(
                  model: watch.digerHayvanlar[index],
                  favoriEkleCikar: () =>
                      read.favoriEkleCikar(watch.digerHayvanlar[index]),
                )
            ),
          );
        },
